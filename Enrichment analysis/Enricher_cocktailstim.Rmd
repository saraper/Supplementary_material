...
model.results = readxl::read_xlsx("downloads/CocktailStim_Organoid_Preli_Deseq2.xlsx")
...
fit <- plot(barplot(enrich.H, showCategory = 5, title = "HALLMARK gene sets",))
...
signif$entrez = mapIds(org.Hs.eg.db, keys = signif$...1,  column="ENTREZID",keytype="ENSEMBL",multiVals="first")
...
# name the vector
names(original_gene_list) <- model.results$...1
...
df2 = model.results[model.results$...1 %in% dedup_ids$ENSEMBL,]
